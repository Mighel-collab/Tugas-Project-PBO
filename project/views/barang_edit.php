    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=barang&fitur=edit&id=<?php echo $barang->id_barang; ?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="harga_barang" name="harga_barang" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Harga Barang" rows="3" required>
                            <?php echo htmlspecialchars($barang->harga_barang); ?>
                        </textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="jumlah_barang" name="jumlah_barang" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan Jumlah Barang" required>
                    </div>
