        ...
        <div class="container mx-auto">
            ...
            <div class="mb-4">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    <a href="index.php?modul=barang&fitur=add">Insert Barang </a>
                </button>
            </div>
            ...
            <div class="bg-white shadow-md rounded my-6">
                <table class="min-w-full bg-white grid-cols-1">
                    ...
                    <tr class="text-center">
                        ...
                        <td class="w-1/3 py-3 px-4"><?php echo htmlspecialchars($barang->harga_barang);?></td>
                        <td class="w-1/6 py-3 px-4"><?php echo htmlspecialchars($barang->jumlah_barang);?></td>
                        <td class="w-1/6 py-3 px-4">
                            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=barang&fitur=update&id=<?php echo htmlspecialchars($barang->id_barang);?>">Update</a>
                            </button>
                            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=barang&fitur=delete&id=<?php echo htmlspecialchars($barang->id_barang);?>">Delete</a>
                            </button>
                        </td>
                    </tr>
                    <?php } ?>
